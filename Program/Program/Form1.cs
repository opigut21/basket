        ...
        private void открытьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (open_dialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    if (image.Width < 1281 || image.Height < 721)
                    {
                        this.Width = image.Width + 40;
                        this.Height = image.Height + 75;
                        this.pictureBox1.Size = image.Size;
                        //label1.Text = Convert.ToString(image.Height) + "x" + Convert.ToString(image.Width);
                    ...
                    else
                    {
                        ...
                        DialogResult rezult = MessageBox.Show("Изображение слишком большое",
